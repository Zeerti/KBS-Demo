...
def index(request):
	...
	context_dict = {'boldmessage': "SITE IS CURRENTLY UNDER CONSTRUCTION! PLEASE ALLOW 360 ANT LIGHT YEARS FOR COMPLETION", 'documents': document_list, 'num_documents':num_documents, }
